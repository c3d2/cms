...
\begin{frame}[fragile]
  ...
  \item Dokument ist unterteilt in \emph{Präambel} und \emph{Dokumentenkörper}
    \begin{itemize}
    \item Das Dokument beginnt mit der Präamble bis zum Befehl
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item Die \emph{Dokumentenklasse} zu spezifizieren; bei uns immer
\begin{lstlisting}
\documentclass{beamer}
\end{lstlisting}

  \item<+-> Pakete einzubinden
    Pakete werden eingebunden mittels
\begin{lstlisting}
