  ...
  \begin{itemize}
    ...
    \only<3>{
      \begin{minipage}{\linewidth}
		  ...
		  \tiny\license{http://www.ctrl-verlust.net/digitaler-tribalismus-und-fake-news/}
      \end{minipage}
    }      
  \end{itemize}		
\end{frame}
...
\begin{frame}
	\frametitle{Display selber bauen}
  	\begin{figure}
	    \only<1>{\includegraphics[height=0.7\textheight]{img/leds1.jpg}}
	    \only<2>{\includegraphics[height=0.7\textheight]{img/leds2.jpg}}
	    \only<3>{\includegraphics[height=0.7\textheight]{img/leds3.jpg}}
	\end{figure}
\end{frame}
