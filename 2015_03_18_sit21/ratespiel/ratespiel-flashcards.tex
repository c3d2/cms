...
\newcommand{\beispiel}[1][{}]{%
		\foreach \kategorie in #1{%
			\foreach \rkategorie in \kategorie{%
				\foreach \recht in \kategorie{%
					\recht
				};
			};
		};
...
\end{tikzpicture}%
\beispiel{{Whatsapp,{In-App-Käufe,
	Geräte- und App-Verlauf{Aktive Apps abrufen}, 
	Identität{Kontaktkarten lesen,
