...
\begin{frame}
  ...
  \begin{itemize}
	...
	\item<3-> => Mehr Werbegewinn durch personalisierte Werbung
        \item<4-> 30\% Anteil an "`Facebook-Einkäufen"'
        \item<5-> durchschnittlich 1€/Profil
        \item<6-> "`Poweruser"'-Profile deutlich mehr        
...
\begin{frame}
  ...
  \begin{center} \Large
     Was habt ihr von sozialen Netzwerken?
  \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<4-> Beispiele:
            ...
            \end{itemize}
        \item<11-> Verschiedene Passwörter nutzen!
        \item<12-> Passwort-Manager verwenden \\ (z.B. Keepass, Password Safe)
    \end{itemize}
\end{frame}
